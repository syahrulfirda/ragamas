        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <center>
                    <h1 class="h3 mb-2 text-gray-800">Kegiatan yang telah di laksanakan Kecamatan Cimahi Selatan</h1>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <td><?php echo $no++?>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?=base_url('admin/del/' . $mhs['id']);?>" class=" btn btn-danger " onclick="return confirm('apakah ada yakin akan menghapusnya ?');"> 
